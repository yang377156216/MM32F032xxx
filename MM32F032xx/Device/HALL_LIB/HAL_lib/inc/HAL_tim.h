...
#define IS_TIM_LIST4_PERIPH(PERIPH)                                                                                              \
    (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM14) || ((PERIPH) == TIM16) ||             \
     ((PERIPH) == TIM17))

/* LIST5: TIM 1, 2, 3, 15, 16 and 17 */
#define IS_TIM_LIST5_PERIPH(PERIPH)                                                                                              \
    (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM16) || ((PERIPH) == TIM17))

/* LIST6: TIM 1, 2, 3  */
#define IS_TIM_LIST6_PERIPH(PERIPH) (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3))

/* LIST7: TIM 1, 2, 3 and 14 */
#define IS_TIM_LIST7_PERIPH(PERIPH) (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM14))

/* LIST8: TIM 1, 2, 3 and 14 */
#define IS_TIM_LIST8_PERIPH(PERIPH) (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM14))

/* LIST9: TIM 1, 2, 3 */
#define IS_TIM_LIST9_PERIPH(PERIPH) (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3))
...
#define IS_TIM_GET_IT(IT)                                                                                                        \
    (((IT) == TIM_IT_Update) || ((IT) == TIM_IT_CC1) || ((IT) == TIM_IT_CC2) || ((IT) == TIM_IT_CC3) || ((IT) == TIM_IT_CC4) ||  \
     ((IT) == TIM_IT_COM) || ((IT) == TIM_IT_Trigger) || ((IT) == TIM_IT_Break))
/**
 * @}
 */
...
#define IS_TIM_DMA_BASE(BASE)                                                                                                    \
    (((BASE) == TIM_DMABase_CR1) || ((BASE) == TIM_DMABase_CR2) || ((BASE) == TIM_DMABase_SMCR) ||                               \
     ...
     ((BASE) == TIM_DMABase_CNT) || ((BASE) == TIM_DMABase_PSC) || ((BASE) == TIM_DMABase_ARR) || ((BASE) == TIM_DMABase_RCR) || \
     ((BASE) == TIM_DMABase_CCR1) || ((BASE) == TIM_DMABase_CCR2) || ((BASE) == TIM_DMABase_CCR3) ||                             \
...
#define IS_TIM_EXT_PRESCALER(PRESCALER)                                                                                          \
    (((PRESCALER) == TIM_ExtTRGPSC_OFF) || ((PRESCALER) == TIM_ExtTRGPSC_DIV2) || ((PRESCALER) == TIM_ExtTRGPSC_DIV4) ||         \
...
#define IS_TIM_TRGO_SOURCE(SOURCE)                                                                                               \
    (((SOURCE) == TIM_TRGOSource_Reset) || ((SOURCE) == TIM_TRGOSource_Enable) || ((SOURCE) == TIM_TRGOSource_Update) ||         \
     ((SOURCE) == TIM_TRGOSource_OC1) || ((SOURCE) == TIM_TRGOSource_OC1Ref) || ((SOURCE) == TIM_TRGOSource_OC2Ref) ||           \
...
#define IS_TIM_SLAVE_MODE(MODE)                                                                                                  \
    (((MODE) == TIM_SlaveMode_Reset) || ((MODE) == TIM_SlaveMode_Gated) || ((MODE) == TIM_SlaveMode_Trigger) ||                  \
...
#define IS_TIM_GET_FLAG(FLAG)                                                                                                    \
    (((FLAG) == TIM_FLAG_Update) || ((FLAG) == TIM_FLAG_CC1) || ((FLAG) == TIM_FLAG_CC2) || ((FLAG) == TIM_FLAG_CC3) ||          \
     ((FLAG) == TIM_FLAG_CC4) || ((FLAG) == TIM_FLAG_COM) || ((FLAG) == TIM_FLAG_Trigger) || ((FLAG) == TIM_FLAG_Break) ||       \
     ((FLAG) == TIM_FLAG_CC1OF) || ((FLAG) == TIM_FLAG_CC2OF) || ((FLAG) == TIM_FLAG_CC3OF) || ((FLAG) == TIM_FLAG_CC4OF))
...
#define TIM_OCREFERENCECECLEAR_SOURCE(SOURCE)                                                                                    \
    (((SOURCE) == TIM_OCReferenceClear_ETRF) || ((SOURCE) == TIM_OCReferenceClear_OCREFCLR))
...
#define IS_TIM_REMAP(TIM_REMAP)                                                                                                  \
    (((TIM_REMAP) == TIM14_GPIO) || ((TIM_REMAP) == TIM14_RTC_CLK) || ((TIM_REMAP) == TIM14_HSEDiv32) ||                         \
     ((TIM_REMAP) == TIM14_MCO))
/**
 * @}
 */
