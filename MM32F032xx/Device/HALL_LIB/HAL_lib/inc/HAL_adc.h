...
#define IS_ADC_ALL_PERIPH(PERIPH) (((*(uint32_t*)&(PERIPH)) == ADC1_BASE) || ((*(uint32_t*)&(PERIPH)) == ADC2_BASE))

#define IS_ADC_DMA_PERIPH(PERIPH) (((*(uint32_t*)&(PERIPH)) == ADC1_BASE) || ((*(uint32_t*)&(PERIPH)) == ADC2_BASE))
...
#define IS_ADC_RESOLUTION(RESOLUTION)                                                                                            \
    (((RESOLUTION) == ADC_Resolution_12b) || ((RESOLUTION) == ADC_Resolution_10b) || ((RESOLUTION) == ADC_Resolution_8b) ||      \
...
#define IS_ADC_EXT_TRIG(REGTRIG)                                                                                                 \
    (((REGTRIG) == ADC_ExternalTrigConv_T1_CC1) || ((REGTRIG) == ADC_ExternalTrigConv_T1_CC2) ||                                 \
     ...
     ((REGTRIG) == ADC_ExternalTrigConv_T1_TRGO) || ((REGTRIG) == ADC_ExternalTrigConv_T1_CC4) ||                                \
     ((REGTRIG) == ADC_ExternalTrigConv_T2_TRGO) || ((REGTRIG) == ADC_ExternalTrigConv_T2_CC1) ||                                \
     ((REGTRIG) == ADC_ExternalTrigConv_T3_CC4) || ((REGTRIG) == ADC_ExternalTrigConv_T4_TRGO) ||                                \
     ((REGTRIG) == ADC_ExternalTrigConv_T3_CC1) || ((REGTRIG) == ADC_ExternalTrigConv_EXTI_15))
/**
 * @}
 */
...
#define IS_ADC_SAMPLE_TIME(TIME)                                                                                                 \
    (((TIME) == ADC_SampleTime_1_5Cycles) || ((TIME) == ADC_SampleTime_7_5Cycles) || ((TIME) == ADC_SampleTime_13_5Cycles) ||    \
     ((TIME) == ADC_SampleTime_28_5Cycles) || ((TIME) == ADC_SampleTime_41_5Cycles) || ((TIME) == ADC_SampleTime_55_5Cycles) ||  \
     ((TIME) == ADC_SampleTime_71_5Cycles) || ((TIME) == ADC_SampleTime_239_5Cycles))
...
#define IS_ADC_INJECTED_CHANNEL(CHANNEL)                                                                                         \
    (((CHANNEL) == ADC_InjectedChannel_1) || ((CHANNEL) == ADC_InjectedChannel_2) || ((CHANNEL) == ADC_InjectedChannel_3) ||     \
     ((CHANNEL) == ADC_InjectedChannel_4) || ((CHANNEL) == ADC_InjectedChannel_5) || ((CHANNEL) == ADC_InjectedChannel_6) ||     \
     ((CHANNEL) == ADC_InjectedChannel_7) || ((CHANNEL) == ADC_InjectedChannel_8))
/**
 * @}
 */
