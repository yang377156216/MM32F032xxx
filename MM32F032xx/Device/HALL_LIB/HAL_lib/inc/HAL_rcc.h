...
#define IS_RCC_PLL_SOURCE(SOURCE)                                                                                                \
    (((SOURCE) == RCC_PLLSource_HSI_Div4) || ((SOURCE) == RCC_PLLSource_HSE_Div1) || ((SOURCE) == RCC_PLLSource_HSE_Div2))
/**
 * @}
 */
...
#define IS_RCC_SYSCLK_SOURCE(SOURCE)                                                                                             \
    (((SOURCE) == RCC_SYSCLKSource_HSI) || ((SOURCE) == RCC_SYSCLKSource_HSE) || ((SOURCE) == RCC_SYSCLKSource_PLLCLK))
/**
 * @}
 */
...
#define IS_RCC_HCLK(HCLK)                                                                                                        \
    (((HCLK) == RCC_SYSCLK_Div1) || ((HCLK) == RCC_SYSCLK_Div2) || ((HCLK) == RCC_SYSCLK_Div4) || ((HCLK) == RCC_SYSCLK_Div8) || \
     ((HCLK) == RCC_SYSCLK_Div16) || ((HCLK) == RCC_SYSCLK_Div64) || ((HCLK) == RCC_SYSCLK_Div128) ||                            \
...
#define IS_RCC_PLL_MUL(MUL)                                                                                                      \
    (((MUL) == RCC_PLLMul_2) || ((MUL) == RCC_PLLMul_3) || ((MUL) == RCC_PLLMul_4) || ((MUL) == RCC_PLLMul_5) ||                 \
     ((MUL) == RCC_PLLMul_6) || ((MUL) == RCC_PLLMul_7) || ((MUL) == RCC_PLLMul_8) || ((MUL) == RCC_PLLMul_9) ||                 \
     ((MUL) == RCC_PLLMul_10) || ((MUL) == RCC_PLLMul_11) || ((MUL) == RCC_PLLMul_12) || ((MUL) == RCC_PLLMul_13) ||             \
...
#define IS_RCC_ADCCLK(ADCCLK)                                                                                                    \
    (((ADCCLK) == RCC_PCLK2_Div2) || ((ADCCLK) == RCC_PCLK2_Div4) || ((ADCCLK) == RCC_PCLK2_Div6) || ((ADCCLK) == RCC_PCLK2_Div8))
/**
 * @}
 */
...
#define RCC_APB2Periph_DBG ((uint32_t)0x00400000)
...
#define RCC_APB1Periph_CSM ((uint32_t)0x04000000)
...
#define IS_RCC_MCO(MCO)                                                                                                          \
    (((MCO) == RCC_MCO_NoClock) || ((MCO) == RCC_MCO_HSI) || ((MCO) == RCC_MCO_SYSCLK) || ((MCO) == RCC_MCO_HSE) ||              \
     ((MCO) == RCC_MCO_PLLCLK_Div2) || ((MCO) == RCC_MCO_LSI) || ((MCO) == RCC_MCO_LSE))
/**
 * @}
 */
...
#define IS_RCC_FLAG(FLAG)                                                                                                        \
    (((FLAG) == RCC_FLAG_HSIRDY) || ((FLAG) == RCC_FLAG_HSERDY) || ((FLAG) == RCC_FLAG_PLLRDY) || ((FLAG) == RCC_FLAG_LSERDY) || \
