...
#define IS_SPI_ALL_PERIPH(PERIPH) (((*(uint32_t*)&(PERIPH)) == SPI0_BASE) || ((*(uint32_t*)&(PERIPH)) == SPI1_BASE))
...
#define IS_SPI_DATASIZE(DATASIZE) (((DATASIZE) == SPI_DataSize_32b) || ((DATASIZE) == SPI_DataSize_8b))
...
#define IS_SPI_DATAWIDRH(WIDTH)                                                                                                  \
    (((WIDTH) == SPI_DataWidth_1b) || ((WIDTH) == SPI_DataWidth_2b) || ((WIDTH) == SPI_DataWidth_3b) ||                          \
     ((WIDTH) == SPI_DataWidth_4b) || ((WIDTH) == SPI_DataWidth_5b) || ((WIDTH) == SPI_DataWidth_6b) ||                          \
     ((WIDTH) == SPI_DataWidth_7b) || ((WIDTH) == SPI_DataWidth_8b) || ((WIDTH) == SPI_DataWidth_9b) ||                          \
     ((WIDTH) == SPI_DataWidth_10b) || ((WIDTH) == SPI_DataWidth_11b) || ((WIDTH) == SPI_DataWidth_12b) ||                       \
     ((WIDTH) == SPI_DataWidth_13b) || ((WIDTH) == SPI_DataWidth_14b) || ((WIDTH) == SPI_DataWidth_15b) ||                       \
     ((WIDTH) == SPI_DataWidth_16b) || ((WIDTH) == SPI_DataWidth_17b) || ((WIDTH) == SPI_DataWidth_18b) ||                       \
     ((WIDTH) == SPI_DataWidth_19b) || ((WIDTH) == SPI_DataWidth_20b) || ((WIDTH) == SPI_DataWidth_21b) ||                       \
     ((WIDTH) == SPI_DataWidth_22b) || ((WIDTH) == SPI_DataWidth_23b) || ((WIDTH) == SPI_DataWidth_24b) ||                       \
     ((WIDTH) == SPI_DataWidth_25b) || ((WIDTH) == SPI_DataWidth_26b) || ((WIDTH) == SPI_DataWidth_27b) ||                       \
     ((WIDTH) == SPI_DataWidth_28b) || ((WIDTH) == SPI_DataWidth_29b) || ((WIDTH) == SPI_DataWidth_30b) ||                       \
...
#define IS_SPI_CS(CS)                                                                                                            \
    (((CS) == SPI_CS_BIT0) || ((CS) == SPI_CS_BIT1) || ((CS) == SPI_CS_BIT2) || ((CS) == SPI_CS_BIT3) ||                         \
     ((CS) == SPI_CS_BIT4) || ((CS) == SPI_CS_BIT5) || ((CS) == SPI_CS_BIT6) || ((CS) == SPI_CS_BIT7))
/**
 * @}
 */
...
#define IS_SPI_DIRECTION(DIRECTION)                                                                                              \
    (((DIRECTION) == SPI_Direction_Rx) || ((DIRECTION) == SPI_Direction_Tx) || ((DIRECTION) == SPI_Disable_Tx) ||                \
...
#define IS_SPI_CONFIG_IT(IT) (((IT) == SPI_IT_TX) || ((IT) == SPI_IT_RX))
...
#define IS_SPI_GET_IT(IT)                                                                                                        \
    (((IT) == SPI_IT_TX) || ((IT) == SPI_IT_RX) || ((IT) == SPI_IT_UNDERRUN) || ((IT) == SPI_IT_RXOVER) ||                       \
...
#define IS_SPI_GET_FLAG(FLAG) (((FLAG) == SPI_FLAG_RXAVL) || ((FLAG) == SPI_FLAG_TXEPT))
...
#define IS_SPI_SlaveAdjust(ADJUST) (((ADJUST) == SPI_SlaveAdjust_FAST) || ((ADJUST) == SPI_SlaveAdjust_LOW))
