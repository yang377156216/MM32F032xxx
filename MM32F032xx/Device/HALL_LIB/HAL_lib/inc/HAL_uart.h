...
#define IS_UART_ALL_PERIPH(PERIPH)                                                                                               \
    (((*(uint32_t*)&(PERIPH)) == UART1_BASE) || ((*(uint32_t*)&(PERIPH)) == UART2_BASE) ||                                       \
     ((*(uint32_t*)&(PERIPH)) == UART3_BASE))
#define IS_UART_123_PERIPH(PERIPH)                                                                                               \
    (((*(uint32_t*)&(PERIPH)) == UART1_BASE) || ((*(uint32_t*)&(PERIPH)) == UART2_BASE) ||                                       \
     ((*(uint32_t*)&(PERIPH)) == UART3_BASE))
...
#define IS_UART_WORD_LENGTH(LENGTH)                                                                                              \
    (((LENGTH) == UART_WordLength_5b) || ((LENGTH) == UART_WordLength_6b) || ((LENGTH) == UART_WordLength_7b) ||                 \
...
#define IS_UART_PARITY(PARITY) (((PARITY) == UART_Parity_No) || ((PARITY) == UART_Parity_Even) || ((PARITY) == UART_Parity_Odd))
/**
 * @}
 */
...
#define IS_UART_HARDWARE_FLOW_CONTROL(CONTROL)                                                                                   \
    (((CONTROL) == UART_HardwareFlowControl_None) || ((CONTROL) == UART_HardwareFlowControl_RTS) ||                              \
     ((CONTROL) == UART_HardwareFlowControl_CTS) || ((CONTROL) == UART_HardwareFlowControl_RTS_CTS))
...
#define IS_UART_CONFIG_IT(IT)                                                                                                    \
    (((IT) == UART_IT_PE) || ((IT) == UART_IT_TXIEN) || ((IT) == UART_IT_RXIEN) || ((IT) == UART_IT_ERR))

#define IS_UART_GET_IT(IT)                                                                                                       \
    (((IT) == UART_IT_PE) || ((IT) == UART_IT_TXIEN) || ((IT) == UART_IT_ERR) || ((IT) == UART_IT_RXIEN) ||                      \
...
#define IS_UART_FLAG(FLAG)                                                                                                       \
    (((FLAG) == UART_FLAG_TXEMPTY) || ((FLAG) == UART_FLAG_TXFULL) || ((FLAG) == UART_FLAG_RXAVL) || ((FLAG) == UART_FLAG_TXEPT))
