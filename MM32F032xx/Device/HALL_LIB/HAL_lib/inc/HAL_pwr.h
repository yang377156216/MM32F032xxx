...
#define IS_PWR_PVD_LEVEL(LEVEL)                                                                                                  \
    (((LEVEL) == PWR_PVDLevel_1V8) || ((LEVEL) == PWR_PVDLevel_2V1) || ((LEVEL) == PWR_PVDLevel_2V4) ||                          \
     ((LEVEL) == PWR_PVDLevel_2V7) || ((LEVEL) == PWR_PVDLevel_3V0) || ((LEVEL) == PWR_PVDLevel_3V3) ||                          \
     ((LEVEL) == PWR_PVDLevel_3V6) || ((LEVEL) == PWR_PVDLevel_3V9) || ((LEVEL) == PWR_PVDLevel_4V2) ||                          \
     ((LEVEL) == PWR_PVDLevel_4V5) || ((LEVEL) == PWR_PVDLevel_4V8))
/**
 * @}
 */
