...
#define IS_DMA_ALL_PERIPH(PERIPH)                                                                                                \
    (((*(uint32_t*)&(PERIPH)) == DMA1_Channel1_BASE) || ((*(uint32_t*)&(PERIPH)) == DMA1_Channel2_BASE) ||                       \
     ((*(uint32_t*)&(PERIPH)) == DMA1_Channel3_BASE) || ((*(uint32_t*)&(PERIPH)) == DMA1_Channel4_BASE) ||                       \
...
#define IS_DMA_MEMORY_DATA_SIZE(SIZE)                                                                                            \
    (((SIZE) == DMA_MemoryDataSize_Byte) || ((SIZE) == DMA_MemoryDataSize_HalfWord) || ((SIZE) == DMA_MemoryDataSize_Word))
/**
 * @}
 */
...
#define IS_DMA_PRIORITY(PRIORITY)                                                                                                \
    (((PRIORITY) == DMA_Priority_VeryHigh) || ((PRIORITY) == DMA_Priority_High) || ((PRIORITY) == DMA_Priority_Medium) ||        \
