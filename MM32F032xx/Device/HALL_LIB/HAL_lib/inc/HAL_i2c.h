...
#define IS_I2C_ALL_PERIPH(PERIPH) (((*(uint32_t*)&(PERIPH)) == I2C1_BASE) || ((*(uint32_t*)&(PERIPH)) == I2C2_BASE))
/** @defgroup I2C_modes
 * @{
 */
...
#define IS_I2C_GET_IT(IT)                                                                                                        \
    (((IT) == I2C_IT_RX_UNDER) || ((IT) == I2C_IT_RX_OVER) || ((IT) == I2C_IT_RX_FULL) || ((IT) == I2C_IT_TX_OVER) ||            \
     ((IT) == I2C_IT_TX_EMPTY) || ((IT) == I2C_IT_RD_REQ) || ((IT) == I2C_IT_TX_ABRT) || ((IT) == I2C_IT_RX_DONE) ||             \
     ((IT) == I2C_IT_ACTIVITY) || ((IT) == I2C_IT_STOP_DET) || ((IT) == I2C_IT_START_DET) || ((IT) == I2C_IT_GEN_CALL))
/**
 * @}
 */
...
#define IS_I2C_GET_FLAG(FLAG)                                                                                                    \
    (((FLAG) == I2C_FLAG_RX_UNDER) || ((FLAG) == I2C_FLAG_RX_OVER) || ((FLAG) == I2C_FLAG_RX_FULL) ||                            \
     ((FLAG) == I2C_FLAG_TX_OVER) || ((FLAG) == I2C_FLAG_TX_EMPTY) || ((FLAG) == I2C_FLAG_RD_REQ) ||                             \
     ((FLAG) == I2C_FLAG_TX_ABRT) || ((FLAG) == I2C_FLAG_RX_DONE) || ((FLAG) == I2C_FLAG_ACTIVITY) ||                            \
     ((FLAG) == I2C_FLAG_STOP_DET) || ((FLAG) == I2C_FLAG_START_DET) || ((FLAG) == I2C_FLAG_GEN_CALL))
...
#define IS_I2C_EVENT(EVENT)                                                                                                      \
    (((EVENT) == I2C_EVENT_RX_UNDER) || ((EVENT) == I2C_EVENT_RX_OVER) || ((EVENT) == I2C_EVENT_RX_FULL) ||                      \
     ((EVENT) == I2C_EVENT_TX_OVER) || ((EVENT) == I2C_EVENT_RD_REQ) || ((EVENT) == I2C_EVENT_TX_ABRT) ||                        \
     ((EVENT) == I2C_EVENT_RX_DONE) || ((EVENT) == (I2C_EVENT_ACTIVITY | I2C_EVENT_STOP_DET)) ||                                 \
