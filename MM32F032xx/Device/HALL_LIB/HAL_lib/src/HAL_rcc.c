 ...
 */
#ifdef MM32L072xx
u32  u32RCC_AHBENR_save = 0x00000014;
void RCC_AHBPeriphClockCmd(uint32_t RCC_AHBPeriph, FunctionalState NewState)
{
    u32 u32RCC_AHBENR_tempA = 0;
    u32 u32RCC_AHBENR_tempB = 0;
    /* Check the parameters */
    assert_param(IS_RCC_AHB_PERIPH(RCC_AHBPeriph));
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    u32RCC_AHBENR_tempA = RCC->AHBENR;
    u32RCC_AHBENR_tempB = 0x0f000000 & u32RCC_AHBENR_tempA;
    u32RCC_AHBENR_tempB = u32RCC_AHBENR_tempB >> 7;

    u32RCC_AHBENR_tempA = 0x000000ff & u32RCC_AHBENR_tempA;
    u32RCC_AHBENR_tempA = u32RCC_AHBENR_tempA | u32RCC_AHBENR_tempB;
    u32RCC_AHBENR_save  = u32RCC_AHBENR_tempA;
    if (NewState != DISABLE) {
        u32RCC_AHBENR_tempA = RCC_AHBPeriph | u32RCC_AHBENR_tempA;
        RCC->AHBENR         = u32RCC_AHBENR_tempA;
    }
    else {
        u32RCC_AHBENR_tempA = (~RCC_AHBPeriph) & u32RCC_AHBENR_tempA;
        RCC->AHBENR         = u32RCC_AHBENR_tempA;
 ...
 *   RCC_APB2Periph_TIM8, RCC_APB2Periph_UART1,RCC_APB2Periph_COMP,
 *   RCC_APB2Periph_ALL
 * @param NewState: new state of the specified peripheral clock.
 *   This parameter can be: ENABLE or DISABLE.
 * @retval : None
 ...
 *   RCC_APB1Periph_PWR, RCC_APB1Periph_DAC, RCC_APB1Periph_CRS,
 *   RCC_APB1Periph_ALL
 * @param NewState: new state of the specified peripheral clock.
 *   This parameter can be: ENABLE or DISABLE.
 * @retval : None
