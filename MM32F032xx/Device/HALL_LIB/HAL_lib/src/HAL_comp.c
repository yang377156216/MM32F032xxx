...
/* Private define ------------------------------------------------------------*/
/* CSR register Mask */
#define COMP_CSR_CLEAR_MASK ((uint32_t)0xC03FBDBD)
...
void COMP_Init(uint32_t COMP_Selection, COMP_InitTypeDef* COMP_InitStruct)
{
    ...
    if ((COMP_Selection != COMP_Selection_COMP4) && (COMP_Selection != COMP_Selection_COMP5)) {
        ...
        tmpreg |= (uint32_t)(COMP_InitStruct->COMP_Output | COMP_InitStruct->COMP_OutputPol | COMP_InitStruct->COMP_Hysteresis |
...
void COMP_POLL_Init(uint32_t COMP_Selection, COMP_POLL_InitTypeDef* COMP_POLL_InitStruct) {}
