...
*    Then SystemInit() function is called, in "startup_MM32F032.s" file, to
...
*    the product used), refer to "HSE_VALUE" define in "MM32F032.h" file.
